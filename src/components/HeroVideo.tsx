  ...
  return (
    <div className="relative w-full min-h-[85vh] sm:min-h-[90vh] flex flex-col items-center justify-between overflow-hidden rounded-b-[40px] shadow-2xl border-b-2 border-[#D4AF37]/50 bg-[#FAF5EF]">
      ...
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#2D0B13]/85 via-[#2D0B13]/30 to-[#2D0B13]/95"></div>
      </div>

      {/* Main Arch Banner (Top Burgundy Card as in video) */}
      <div className="relative z-10 my-auto text-center px-6 py-10 flex flex-col items-center w-full max-w-sm">
        {/* Burgundy Arch Frame */}
        <div className="w-full rounded-t-[100px] rounded-b-3xl bg-[#701026]/90 border-2 border-[#D4AF37] p-8 shadow-2xl backdrop-blur-sm relative overflow-hidden flex flex-col items-center">
          ...
          <p className="font-serif-title text-xs uppercase tracking-[0.3em] text-[#FCF6BA] mt-6 mb-2 font-semibold">
            ҮЙЛӨНҮҮ ТОЙ
          </p>

          {/* Couple Names in Elegant Script */}
          <h1 className="font-script text-5xl sm:text-6xl font-bold gold-gradient-text my-2 leading-none drop-shadow-md">
            Канат & Бактыгүл
          </h1>
          ...
          <div className="mt-6 pt-4 border-t border-[#D4AF37]/40 w-full flex flex-col items-center">
            <span className="font-sans-clean text-[10px] uppercase tracking-widest text-[#FCF6BA]">
              Ишемби
            </span>

            <div className="flex items-center justify-center gap-3 my-1">
              <span className="text-3xl font-bold font-serif-title gold-gradient-text px-4 py-0.5 rounded-full border border-[#D4AF37] bg-[#2D0B13]/40">
                12
              </span>
            </div>

            <span className="font-serif-title text-sm font-semibold uppercase tracking-wider text-[#FCF6BA]">
              Сентябрь • 2026
            </span>
          </div>
        </div>
